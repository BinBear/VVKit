...
- (UIImage *)vv_setRadius:(CGFloat)radius size:(CGSize)size {
    return [UIImage vv_setVVRadius:VVRadiusMake(radius, radius, radius, radius) image:self size:size borderColor:nil borderWidth:0 backgroundColor:nil withContentMode:UIViewContentModeScaleAspectFill];
}

- (UIImage *)vv_setRadius:(CGFloat)radius size:(CGSize)size contentMode:(UIViewContentMode)contentMode {
    return [UIImage vv_setVVRadius:VVRadiusMake(radius, radius, radius, radius) image:self size:size borderColor:nil borderWidth:0 backgroundColor:nil withContentMode:contentMode];
}

+ (UIImage *)vv_setRadius:(CGFloat)radius size:(CGSize)size borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth backgroundColor:(UIColor *)backgroundColor {
    return [UIImage vv_setVVRadius:VVRadiusMake(radius, radius, radius, radius) image:nil size:size borderColor:borderColor borderWidth:borderWidth backgroundColor:backgroundColor withContentMode:UIViewContentModeScaleToFill];
}

+ (UIImage *)vv_setVVRadius:(VVRadius)radius image:(UIImage *)image size:(CGSize)size borderColor:(UIColor *)borderColor borderWidth:(CGFloat)borderWidth backgroundColor:(UIColor *)backgroundColor withContentMode:(UIViewContentMode)contentMode {
    ...
    radius = [UIImage transformationVVRadius:radius size:size borderWidth:borderWidth];
...
+ (VVRadius)transformationVVRadius:(VVRadius)radius size:(CGSize)size borderWidth:(CGFloat)borderWidth {
